...
<%@ page import="com.Railworld.JobApp.model.JobPost" %>
<%@ page import="com.Railworld.JobApp.repo.JobRepo" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<nav class="navbar navbar-expand-lg navbar-light bg-warning">
    <div class="container">
        <a class="navbar-brand fs-1 fw-medium" href="#">Nittan Job Portal Web App</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="http://github.com/Nittankumar12">Contact</a></li>
            </ul>
        </div>
    </div>
</nav>
